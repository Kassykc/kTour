<template>
    <div class="flex h-full gap-x-10 min-w-[250px] h-full">
        <div
...
const menus = [
    { titlePath: 'menu.1', url: '/' },
    { titlePath: 'menu.2', url: '/' },
    { titlePath: 'menu.3', url: '/' },
    { titlePath: 'menu.4', url: '/' },
    { titlePath: 'menu.5', url: '/' },
    { titlePath: 'menu.6', url: '/' },
]
</script>
