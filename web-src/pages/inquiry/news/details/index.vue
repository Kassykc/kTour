            ...
            <div id="new_details" class="w-full max-w-[1340px] my-0 mx-auto">
                ...
                <div class="content py-[80px] text-center">
                    ...
                    <div class="text-[16px] leading-[29px]">
                        Medi-City Co., Ltd. announced on the 19th that it visited the National University Hospital of Indonesia,<br/>
                        RSUI (Rumah Sakit Universitas Indonesia), and the National Cancer Center in Korea, which leads international medical cooperation projects.<br/>
                        During this visit, hosted by Medi-City Co., Ltd., RSUI's Director Astuti met with National Cancer Center Director Seo Hong-Gwan<br/>
                        to discuss ways to enhance medical technology and service levels, as well as to explore cooperation for development in various fields.<br/> 
                        In response, the National Cancer Center introduced Korea's advanced medical technology and infrastructure to Indonesia.<br/>
                        RSUI's Director Astuti remarked, "I am deeply impressed by Korea's medical technology and systems,<br/>
                        and I look forward to innovating Indonesia's medical system through cooperation with the National Cancer Center."<br/>
                        Medi-City Chairman Lee Ji-Sun said, "Through continuous international medical cooperation and technological exchanges,<br/>
                        we will contribute to the medical development of both countries, starting with the successful launch of the global medical platform K-Medi in<br/>
                        Indonesia this coming July.<br/>
                        " She added, "These efforts will be an important step in promoting the health of the people and improving the quality of medical services in<br/>
                ...
                <div class="flex flex-col justify-start items-start w-full max-w-[924px] mx-auto">
                    <div class="prev border-t border-b border-[#DADADA] flex justify-start items-center w-full">
                        <div class="font-[700] text-[17px] bg-[#EFEFEF] py-[10px] px-[20px] flex-0 w-[154px]">Previous</div>
                        <div class="font-[400] text-[15px] py-[10px] px-[20px] flex-1 cursor-pointer truncate"
                        @click="movePage('/')"
                        >
                            Medi-City Co., Ltd. Indonesia Branch successfully concludes the K-AESTHETIC & ART Medical Showcase!
                        </div>
                    </div>
