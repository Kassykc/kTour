<template>
    ...
    <AdminCommonBoardTableBoard :list="boardList" :paging="pageInfo" :columns="columns" :columnsWidth="columnsWidth"
        ...
        :popupComp="MiceReg" :rowKey="'boardIdx'" :getBoardList="setBoardList" :useExcelDown="false" @excelDown="goExcel"
...
import MiceReg from '~/components/layer/admin/MiceReg.vue';
