<template>
    ...
    <AdminCommonBoardTableBoard :list="boardList" :paging="pageInfo" :columns="columns" :columnsWidth="columnsWidth"
        ...
        :popupComp="ItReg" :rowKey="'boardIdx'" :getBoardList="setBoardList" :useExcelDown="false" @excelDown="goExcel"
...
import ItReg from '~/components/layer/admin/ItReg.vue';
